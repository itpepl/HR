	...
	formatter: function (value, row, column, data, default_formatter) {
		...
		if (!summarized_view) {
			if ((group_by && column.colIndex > 3) || (!group_by && column.colIndex > 2)) {
				...
				else if (value == "H") value = "<span style='color:#914EE3'>" + value + "</span>";
				else if (value == "WO") value = "<span style='color:#6c757d'>" + value + "</span>";
				else if (/^RH\d+$/.test(value)) value = "<span style='color:#FFC107'>" + value + "</span>";
				else value = "<span style='color:#878787'>" + value + "</span>";
			}
		}	
		return value;
